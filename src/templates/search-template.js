...
const authors = [
  {
    ...
    titleText:
      "Belarusian Soviet director, screenwriter, operator. Honored art worker of the Belarusian SSR (1974)",
  ...
  },
  {
    ...
    titleText:
      "Soviet Belarusian documentary filmmaker. Winner of the State Prize of the USSR (1985), Honored Artist of the Byelorussian SSR (1977), National Artist of the Byelorussian SSR (1989).",
  ...
  },
  {
    ...
    bday: "22.10.1933 - 19.07.2010",
    titleText:
      "Belarusian Soviet film director, actor, teacher and screenwriter, National Artist of the Byelorussian SSR (1985). Member of the CPSU since 1963",
  ...
  },
  {
    ...
    titleText:
      "Belarusian Soviet film director, film actor. Peoples Artist of the USSR. Laureate of the Stalin Prize. One of the founders of Belarusian cinema.",
  ...
  },
  {
    ...
    titleText:
      "Soviet and Belarusian film director, peoples artist of Belarus.",
  ...
  },
  {
    ...
    titleText:
      'Soviet and Belarusian film director, screenwriter, cameraman, director of "Belarusian Video Center", Director of the National Film Studio "BelarusFilm".',
  ...
  },
  {
    ...
    titleText:
      "During his short creative life, Viktor Turov made 26 films that represent the golden fund of Belarusian cinema.",
    ...
    <Layout location={location}>
      <div className="container-fluid">
        <section className="authors-list">
          ...
          <SearchDirector authors={transform(nodes)} lang={pageContext.lang} />
        </section>
      </div>
    </Layout>
  )
